...
/**
 * @brief  Configure snowleosdr lms6002's sample clock.
 *
 * @param[in] i2c_dev     i2c device name,e.g. "/dev/i2c-0"
 * @param[in] sample      0:3.25MHz  1:1.2288*4MHz 2:3.2MHz 3:15.36MHz 4:40MHz
 *
 * @retval                0 Success, -1 Fail
 *
 */
extern int snowleo_sdr_set_clock(char *i2c_dev, int sample);
